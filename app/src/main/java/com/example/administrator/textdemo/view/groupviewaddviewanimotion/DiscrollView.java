...
public class DiscrollView extends ScrollView {//最外部的滑动view
    ...
    private void onScrollChanged(int top) {//滑动改变的时候  实现动画效果
        int scrollViewHeight = getHeight();
        int scrollViewBottom = getAbsoluteBottom();//获取下一个view
