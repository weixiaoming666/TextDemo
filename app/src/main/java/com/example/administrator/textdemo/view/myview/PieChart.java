...
public class PieChart extends View {
    ...
    private float mTextWidth =0;//linshi
    private float mTextHeight = 0;
    private RectF mShadowBounds;
    private AbstractSequentialList mData;
...
//        在onDraw方法里面创建绘制对象会严重影响到性能并使得你的UI显得卡顿。
        ...
        // Draw the label text
        canvas.drawText("woxihuanni", 100f, 100f, mTextPaint);
...
//        }
        ...
        // Draw the pointer
        canvas.drawLine(100f, 100f, 100f, 100f, mTextPaint);
        canvas.drawCircle(100f, 100f, 100f, mTextPaint);
    }
    ...
    private void init() {
        ...
        if (mTextHeight == 0) {
            mTextWidth =mTextPaint.getStrokeWidth();
        ...
        mShadowPaint.setMaskFilter(new BlurMaskFilter(8, BlurMaskFilter.Blur.NORMAL));
         mShadowBounds = new RectF(200f, 100f, 200f, 100f);
